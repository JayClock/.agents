---
name: hunt
description: "Find the root cause of errors, crashes, regressions, screenshot-reported defects, unexpected behavior, failing tests, stack traces, and problems that used to work before applying a fix. Use for 排查, 查查, 报错, 崩溃, 不工作, 不对, 跑不通, 回归, 以前是好的, debug, regression, used to work, broke after update, why broken, not working, fix error, or stack trace. Not for code review or new features."
---
