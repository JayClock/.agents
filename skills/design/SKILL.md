---
name: design
description: "Produce distinctive production-grade UI for components, pages, frontend styling, typography, layout, visual systems, and screenshot-driven visual iteration. Use when the user asks to design, build, or improve UI, pages, components, styles, typography, frontend visuals, or says a screenshot looks bad, unclear, inconsistent, awkward, ugly, or visually wrong. Not for backend logic or data pipelines."
---
