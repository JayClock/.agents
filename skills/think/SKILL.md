---
name: think
description: "Turn rough ideas into approved, decision-complete plans before writing code, covering new features, architecture decisions, implementation approaches, and value judgments about whether to build, keep, pivot, or remove something. Use for 出方案, 给方案, 深入分析, 怎么设计, 用什么方案, 判断一下, 有没有必要, 值不值得, best approach, plan this, how should I, or should we keep this. Not for straightforward bug fixes or small edits."
---
