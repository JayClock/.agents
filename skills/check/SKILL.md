---
name: check
description: "Review code diffs and release-ready changes after implementation, execute approved implementation plans, extract repository constraints, auto-fix safe issues, and handle approved commit, push, publish, release, release-reaction, issue, and PR follow-through. Use for code review, before merge, before release, checking changes, optimizing implemented code, triaging issues or PRs, and release or ship requests. Not for exploring ideas, debugging root causes, or document prose review."
---
