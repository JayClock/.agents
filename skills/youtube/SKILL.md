---
name: youtube
description: "Download YouTube transcripts, subtitles, metadata, chapters, speaker-labelled transcript drafts, and cover images by URL or video ID. Use when the user asks for YouTube captions, transcripts, subtitles, 视频字幕, YouTube 字幕, video thumbnails, YouTube 封面, or provides a YouTube URL and wants readable text or media extracted."
version: 1.1.0
metadata:
  openclaw:
...
# YouTube: Transcripts and Covers
