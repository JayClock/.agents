---
name: read
description: "Fetch any URL or PDF as clean Markdown for reading, quoting, citation, saving, or downstream work. Use when the user asks to read, fetch, check, scrape, save, or convert a webpage, PDF, X/Twitter link, WeChat article, Feishu/Lark document, GitHub URL, or Chinese-platform page. Not for local text files already in the repo."
---
